...
# TODO: 2nd laser, addr 142 (already dmx'd in)
# TODO: hue
    ...
    Scene('main', [
        Program('base', [
            Effect('base', [
                ...
                # TODO: this makes gobo/color wheels freak out, find another way
        ...
        # Program('back_move', [
        #     Effect('sweep_v', [
        #         SweepMovementTransition(300, 110, 360, 10, 1, duration_beat=4, groups=['odd']),
        #         SweepMovementTransition(370, 110, 300, 10, 1, duration_beat=4, groups=['even']),
        #         # TODO: reset seems slow???
        #         # SweepMovementTransition(360, 10, 300, 110, 1, duration_beat=4, delay=1, delay_beat=4, groups=['odd']),
        #         # SweepMovementTransition(360, 10, 370, 110, 1, duration_beat=4, delay=1, delay_beat=4, groups=['even']),
        #     ]),
        ...
        #         # TODO: weird movement to rear? think we're getting weird data or attempting to reset to 0
        ...
        #     #     # TODO: just this one doesn't work
